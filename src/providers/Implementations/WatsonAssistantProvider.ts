...
import { IWatsonAssistantProvider, IMessageDTO, IResponseDTO} from "../IWatsonAssistantProvider";
...
export class WatsonAssistantProvider implements IWatsonAssistantProvider {
    ...
    constructor(){
        ...
        this.response_object = {
            message: 'Unexpected error. Please try again later. The Watson Assistant service is not available.',
            user_id: '',
        };
    };
